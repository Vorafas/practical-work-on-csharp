...
namespace task_1
{
    public partial class Form2 : Form
    {
        ...
        private void одномерныйМассивToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Form1 newForm = new Form1();
            newForm.Show();
        }

        private void двумерныйМассивToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Form2 newForm = new Form2();
            newForm.Show();
        }
